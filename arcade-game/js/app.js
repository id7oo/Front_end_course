...
// All eneimeies will come out from -5.
var allEnemies = [];
(function setEnemies() {
    // allEnemies.push(new Enemy(-5, 50)); more difficulty.
    allEnemies.push(new Enemy(-5, 100));
    allEnemies.push(new Enemy(-5, 150));
    allEnemies.push(new Enemy(-5, 200));
    // allEnemies.push(new Enemy(-5, 250)); more difficulty.
}());
